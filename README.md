# AgentPrecept ![version](https://img.shields.io/badge/version-v0.4.0-blue)
...
**15 维审计**：`agentprecept audit --gate` 一行命令跑完 15 维自动化（命名/引用/编号/骨架/图格式/设计追溯/覆盖率/狗粮/声明校验/设计覆盖/分支策略/commit粒度/术语一致/内容一致/体验审计）。+ 4 维自选清单在报告末尾提示。
